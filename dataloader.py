...
class KDDCupData:
    def __init__(self, data_dir, mode):
        ...
        ixs = jax.random.permutation(normal_data.shape[0])
    ...
    def __getitem__(self, index):
        ...
        return jnp.float32(self.x[index]), jnp.float32(self.y[index])

def get_dataloaders(batch_size, data_dir='./data/kddcup.npz'):
